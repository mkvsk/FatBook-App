...
import online.fatbook.fatbookapp.ui.recipe.adapters.RecipeCookingDifficultyAdapter
        ...
        recipeEditViewModel.recipeImage.observe(viewLifecycleOwner) {
            when (it) {
                null -> {
                    ...
                    binding.imageviewPhotoRecipe1Stage
                        .setImageResource(R.drawable.default_recipe_image_recipe_create_first_stage_step)
                    toggleImageButtons(false)
                }
            }
        }
