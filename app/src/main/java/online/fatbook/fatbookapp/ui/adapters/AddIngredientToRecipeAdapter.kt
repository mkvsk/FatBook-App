...
class AddIngredientToRecipeAdapter(context: Context?, private var list: List<Ingredient?>?) :
    RecyclerView.Adapter<AddIngredientToRecipeAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        holder.tvIngredient.text = ingredient.getName()
