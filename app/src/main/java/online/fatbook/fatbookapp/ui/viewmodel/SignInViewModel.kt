...
class SignInViewModel : ViewModel() {
    ...
    private val isFatValid = MutableLiveData<Boolean>()
    private val isLoginAvailable = MutableLiveData<Boolean?>()
    ...
    fun setFatValid(valid: Boolean) {
        isFatValid.value = valid
    }

    fun getFatValid(): LiveData<Boolean> {
        return isFatValid
    }

    fun setLoginAvailable(available: Boolean?) {
        isLoginAvailable.value = available
    }

    fun getLoginAvailable(): LiveData<Boolean?> {
